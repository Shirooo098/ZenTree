                ...
                <section className="flex flex-col gap-8 md:gap-12 lg:gap-16">
                    <article className='flex flex-col lg:flex-row justify-center items-center gap-2 mt-10 md:gap-4 lg:gap-8'>
                        ...
                        <div className="w-full lg:w-1/2 p-2 sm:p-4">
                            ...
                            <p className={`${ManRope.className} indent-5 pl-0 lg:pl-6 mt-4 sm:mt-6 md:mt-8 text-sm sm:text-base md:text-lg lg:text-xl tracking-wide `}>The Ginseng Ficus (Ficus microcarpa) is a popular bonsai variety admired for its thick, gnarled trunk that resembles ginseng roots,
