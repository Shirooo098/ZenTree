...
export default function OrderPage() {
  ...
  const handleRefundSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!reason) return alert("Please select a reason for refund.");
    setSubmitted(true);
        ...
        <div className="bg-white w-full rounded-lg shadow-md p-8">
          <div className="flex items-center justify-between mb-6">
            ...
            {(order.order_status_name.toLowerCase() === "pending" ||
              ...
              <button
                className="bg-red-900 hover:bg-red-950 text-white font-medium px-4 py-2 rounded-lg transition"
          ...
          <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-6 relative">
            ...
            <form onSubmit={handleRefundSubmit} className="space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 rounded-lg bg-red-900 hover:bg-red-950 text-white transition"
                >
                  Submit Refund
                </button>
              </div>
