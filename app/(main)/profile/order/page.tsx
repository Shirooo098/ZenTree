...
export default function OrderPage() {
  ...
  // Check if order is delivered to show review buttons
  const isDelivered = order.order_status_name.toLowerCase() === "delivered";
          ...
          <div className="border-t pt-6">
            ...
            <div className="space-y-4">
              {order.products.map((item) => (
                <div
                  key={item.product_id}
                  className="flex gap-4 items-center py-3 border-b last:border-b-0"
                >
