...
const EmailVerify = (props: EmailVerifyProps) => {
          ...
          <Container className="bg-white rounded-[8px] p-[32px] max-w-[600px] mx-auto">
            <Section>
              ...
              <Text className="text-[16px] text-gray-700 mb-[24px] mt-0 leading-[24px]">
                Thanks {username} To complete your registration and start using your account, 
              ...
              <Text className="text-[12px] text-gray-500 mt-0 mb-0">
