...
import { imageUploadAuthenticator } from "@/app/actions/image-authenticator.action";
...
export default function UploadProductForm(){
    ...
    const handeImageChange = (e: React.ChangeEvent<HTMLInputElement>, field:any) => {
        if(e.target.files?.[0]){
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                                <Input 
                                    ...
                                    ref={fileInputRef}
                                    onChange={(e) => handeImageChange(e, field)}
                                />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
